...
document.addEventListener("DOMContentLoaded", async () => {
  if (window.__BUSINESS_DATA__) {
    renderBusinessDataV2(window.__BUSINESS_DATA__);
  } else {
    try {
...
function renderBusinessDataV2(data) {
  ...
  if (taglineEl) {
    taglineEl.innerHTML = `
      ...
      <span class="hero-title-sub" style="display:block; font-size:1.15rem; color:#38BDF8; font-weight:600;">Precision Climate Engineering &amp; HVAC &bull; <span class="city-name-text">${city}</span></span>
    `;
  }
